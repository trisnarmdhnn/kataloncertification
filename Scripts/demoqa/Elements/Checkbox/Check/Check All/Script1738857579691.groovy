...
WebUI.click(findTestObject('Object Repository/demoqa/Elements/Checkbox/Page_DEMOQA/svg_Check Box_rct-icon rct-icon-expand-all'))

WebUI.click(findTestObject('Object Repository/demoqa/Elements/Checkbox/Page_DEMOQA/svg_Check Box_rct-icon rct-icon-uncheck'))
